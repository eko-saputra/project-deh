...
@endsection
@section('tombol')
<a href="{{route('tambah.level')}}" class="btn btn-outline-light btn-rounded get-started-btn"><i class="mdi mdi-account-convert"></i> TAMBAH LEVEL</a>
@endsection
@section('user')
@auth
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3 border">
                    <table class="table shadow tabellevel">
